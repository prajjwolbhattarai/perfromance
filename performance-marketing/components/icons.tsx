...
export const GoogleSheetsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" {...props}>
        <path fill="#188038" d="M18 28H8a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h10v10h10v12a2 2 0 0 1-2 2z"/>
        <path fill="#20a144" d="m20 2l8 8h-8V2z"/>
        <path fill="#eef9f2" d="M21 17h-8v-2h8v2zm-8 4h8v-2h-8v2zm8-6h-8v-2h8v2z"/>
    </svg>
);
...
export const MetaIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M12,2.04C6.5,2.04 2,6.54,2,12.04C2,17.04 5.67,21.23 10.44,21.94V14.87H7.56V12.04H10.44V9.81C10.44,7.04 12.13,5.44 14.63,5.44C15.82,5.44 16.94,5.63 16.94,5.63V8.01H15.65C14.33,8.01 13.9,8.73 13.9,9.97V12.04H16.8L16.36,14.87H13.9V21.94C18.33,21.23 22,17.04 22,12.04C22,6.54 17.5,2.04 12,2.04Z" />
    </svg>
);
...
export const TikTokIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16" {...props}>
    <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2.19c-.863.009-1.745-.166-2.615-.49a5.02 5.02 0 0 1-2.5-1.808v5.226a2.5 2.5 0 1 0-2.5 2.5V3.109a2.502 2.502 0 0 0-4.43-1.422A2.5 2.5 0 0 0 1 5.5v2.66h2V5.5a.5.5 0 0 1 .5-.5c.145 0 .285.05.4.14L5 6.66v4.61a2.5 2.5 0 1 0 2.5 2.5V.03Z"/>
  </svg>
);

export const RedditIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-8h2v2h-2v-2zm-2-2h6v2H9v-2z"/></svg>
);
export const SpotifyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/><path d="M7 15.5c2.5-1 5.5-1 8 0"/><path d="M7 12c3-1.5 6-1.5 9 0"/><path d="M8 8.5c3.5-2 7.5-2 11 0"/></svg>
);
